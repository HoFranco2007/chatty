      ...
      <main className="h-[100vh] w-[100vw] bg-black grid-background">
        <section className="grid grid-cols-2 items-center w-[100vw]">
          ...
          <aside className="col-span-1 flex justify-center items-center">
            ...
            <div className="bg-[#0e0e0e] w-[40vw] h-[69vh] mr-[12vw] flex flex-col py-[3vh] px-[2vw] rounded">
              ...
              <div className="ml-[.5vw] mt-[.5vh]">
                <div className="mt-[2vh] text-sm tracking-normal">
                  <p className="mt-[.5vh] text-[#CCCCCC]">New user? <a className="text-[#700079] underline-offset-0 hover:underline transition-all duration-300 ml-[0.1vw]" href="">Create an Account</a></p>
                </div>
              </div>

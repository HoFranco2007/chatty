      ...
      >
        ...
        <div className="flex-col mt-[1.5vh] mb-[2vh]">
          ...
          <input
            ...
            onChange={handleInputChange}
            className="px-4 py-[1.5vh] mb-[.5vh] rounded text-sm text-[#CCCCCC]/50 w-[30vw] bg-transparent border border-[#CCCCCC]/70 focus:outline-none hover:border-white focus:border-white placeholder-[#CCCCCC]/50 focus:placeholder-transparent transition-colors duration-500"
          />
        </div>
